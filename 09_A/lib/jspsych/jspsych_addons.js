/** 
* Add new methods to jsPsych object
*
...
jsPsych.typingFeedbackBlock = function(trialtyp_names, Nsubpart) {
	...
	function keyseq_score_div(){
		...
		//---- For the current block "Part [Nk] :" in bold
		icur = Nk -1;
	...
	var seq_debrief_block = {
		...
		text: function() {
			...
			return 	"<div width=65%><div class='large'><p>Perfomance summary :</p></div> "+
					"<p class='small'><b>Average typing speed in words per minute : </b></p>" +
					scorediv.stt_all +
					"<br /><p>Press any key to continue! </p></div>"+
					"<div class='fb_info'><p>For your information : </p><p>a) The average typing speed for word copying is 33 words per minute (wpm), and 50 to 70 for a professional typist, with up to 120 wpm for the fastest typists.</p><p>b) The estimation of your typing speed is done here without taking errors into account.</p></div>";
		},
